...
// // SambaNova API details
// const API_URL = 'https://api.sambanova.ai/v1/chat/completions'; // Replace with actual API URL
// //const API_KEY = process.env.SAMBANOVA_API_KEY; // Your API Key
// const API_KEY = '6217c0cf-93a4-404e-baff-a8d3a47bfab1';
...
//             { 
//                 role: 'system', 
//                 content: "You are a helpful assistant. Extract the total spent, the type of expense (grocery, shopping, restaurant, etc.), and the date from the following receipt text. Ensure the date is in MM/DD/YYYY format." 
//             },
//             { 
//                 role: 'user', 
//                 content : text
...
//     console.log("afhjhjvhvggcgvhhjvjvh,bhjbjhbjknb")
//       // Step 3: Send the extracted text to SambaNova API for parsing
...
//       const choices = parseResponse.choices;
//       console.log("print " + choices);

//       if (choices && choices.length > 0) {
//         const responseText = choices[0].message.content;

//         // Example of structured response parsing
//         const totalMatch = responseText.match(/Total:\s*([\d.]+)/);
//         const dateMatch = responseText.match(/Date:\s*(\d{2}\/\d{2}\/\d{4})/);
//         const typeMatch = responseText.match(/Type:\s*([a-zA-Z]+)/);

//         const total = totalMatch ? totalMatch[1] : null;
//         const date = dateMatch ? dateMatch[1] : null;
//         const expense_type = typeMatch ? typeMatch[1] : null;

//         if (total && date && expense_type) {
//             return res.json({
//               total,
//               expense_type,
//               date,
